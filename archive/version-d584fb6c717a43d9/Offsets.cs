...
namespace Offsets {
    ...
    public static class DataModel {
         ...
         public const long ToRenderView1 = 0x100;
         public const long ToRenderView2 = 0x8;
         public const long ToRenderView3 = 0x8;
    ...
    public static class RenderJob {
         public const long RenderView = 0x0;
    }
    ...
    public static class RunService {
         public const long HeartbeatFPS = 0xec;
         public const long HeartbeatTask = 0x2a0;
    }
    ...
    public static class TaskScheduler {
         public const long JobEnd = 0x0;
         public const long JobName = 0x0;
         public const long JobStart = 0x0;
         public const long MaxFPS = 0x1000;
