...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-90f2fddd3b244ff6";
    }
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7cb3d78;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7e743c8;
    }
    ...
    public static class ProximityPrompt {
         ...
         public const long HoldDuration = 0x97;
    ...
    public static class RunService {
         public const long HeartbeatFPS = 0xd0;
         public const long HeartbeatTask = 0x308;
    }
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x8244248;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x83d1f98;
