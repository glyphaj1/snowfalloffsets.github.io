...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-ad5d3e2906444472";
    }
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x78ff228;
    ...
    public static class Player {
         ...
         public const long ModelInstance = 0x280;
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x7e90548;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x801dfb0;
