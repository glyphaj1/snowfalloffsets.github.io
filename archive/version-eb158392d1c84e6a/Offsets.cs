...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-eb158392d1c84e6a";
    }
    ...
    public static class AnimationTrack {
         ...
         public const long IsPlaying = 0x42a;
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x851f568;
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x80b7468;
    }
    ...
    public static class Tool {
         ...
         public const long ManualActivationOnly = 0x1d5;
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x824b728;
