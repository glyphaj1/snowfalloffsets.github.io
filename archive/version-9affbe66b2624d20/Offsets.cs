...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-9affbe66b2624d20";
    }
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x85c6908;
    ...
    public static class RunService {
         public const long HeartbeatFPS = 0xd2;
         public const long HeartbeatTask = 0x1a0;
    }
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x815d398;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x82f16a8;
