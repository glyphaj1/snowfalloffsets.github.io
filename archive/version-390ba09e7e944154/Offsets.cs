...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-390ba09e7e944154";
    }
    ...
    public static class BloomEffect {
         public const long Enabled = 0xa7;
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7b991d8;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7c388d0;
    }
    ...
    public static class PlayerConfigurer {
         public const long Pointer = 0x7b6e7e8;
    }
    ...
    public static class ProximityPrompt {
         ...
         public const long KeyCode = 0xa7;
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x7c73e50;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x7746260;
