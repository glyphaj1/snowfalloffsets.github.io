...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-ed2b47b81f08484a";
    }
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7dccd88;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7f90688;
    }
    ...
    public static class RunService {
         ...
         public const long HeartbeatTask = 0x24b8;
    }
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x836aae8;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x84f8808;
