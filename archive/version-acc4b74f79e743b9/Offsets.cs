...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-acc4b74f79e743b9";
    }
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7c1a148;
    ...
    public static class Instance {
         ...
         public const long ClassBase = 0xe48;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7cb9ad0;
    }
    ...
    public static class PlayerConfigurer {
         public const long Pointer = 0x7bee8e8;
    }
    ...
    public static class RunService {
         ...
         public const long HeartbeatTask = 0x138;
    }
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x7cf5400;
    }
    ...
    public static class VisualEngine {
         public const long Dimensions = 0xa90;
         public const long FakeDataModel = 0xa70;
         public const long Pointer = 0x77c6670;
         public const long RenderView = 0xb70;
    ...
    public static class World {
         ...
         public const long worldStepsPerSec = 0x6b8;
    }
