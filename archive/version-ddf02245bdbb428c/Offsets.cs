...
namespace Offsets {
    public static class Info {
        public static string ClientVersion = "version-ddf02245bdbb428c";
    }
    ...
    public static class FakeDataModel {
         public const long Pointer = 0x7d28508;
    ...
    public static class MouseService {
         ...
         public const long SensitivityPointer = 0x7ee9b58;
    }
    ...
    public static class Player {
         ...
         public const long MaxZoomDistance = 0x1bd;
    ...
    public static class TaskScheduler {
         ...
         public const long Pointer = 0x82b9f48;
    }
    ...
    public static class UnionOperation {
         public const long AssetId = 0x290;
    }
    ...
    public static class VisualEngine {
         ...
         public const long Pointer = 0x8447c68;
    ...
    public static class World {
         ...
         public const long Gravity = 0x1a4;
         public const long Primitives = 0x0;
         public const long worldStepsPerSec = 0xc16;
    }
